...
df = pd.read_csv(f'{BASE}/2026-07-29_tradeoff_merged_v3.csv')
...
fig.suptitle('해상도(1/5/10/15/30m)별 소요시간 vs 정밀도 트레이드오프 (v3, 링크버퍼 버그수정판)', fontsize=14, y=1.0)
path1 = f'{FIG_DIR}/2026-07-29_resolution_tradeoff_speed_vs_precision_v3.png'
...
path2a = f'{FIG_DIR}/2026-07-29_resolution_feasibility_threshold_v3_left.png'
...
path2b = f'{FIG_DIR}/2026-07-29_resolution_feasibility_threshold_v3_right.png'

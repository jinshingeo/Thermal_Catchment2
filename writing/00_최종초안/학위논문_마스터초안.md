...
2020). 여러 이동 방식 중 실외에서 신체 활동이 필연적으로 수반되는 보행의
경우 폭염 시 직접적인 열노출로 인한 위협이 더욱 커질 것이다(Basu et al.,
2024). 그럼에도 불구하고 도시 보행 공간은 대체로 기능성 위주로 계획되어
기후적 쾌적성에 대한 고려가 부족한 경우가

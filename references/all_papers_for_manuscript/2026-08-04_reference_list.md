...
- **인용 위치**: Study Area 1단락(v4) — "서울의 폭염일수(일 최고기온 33°C
  이상인 날)는 1970년대 연평균 5.5일에서 2020년대 20.0일로 약 3.6배
  증가하였다. 같은 기간 열대야일수는 5.0일에서 29.5일로 약 5.9배
  증가하여...(기상청, 2025)."
- **서지정보**: 기상청 (2025-12-29). 「우리나라 113년 기후변화 분석
  보고서」 발간 보도자료.
  (`references/all_papers/20251229_보도자료_「우리나라+113년+기후변화+
  분석+보고서」+발간.pdf`, 전체 보고서 원문:
  `references/all_papers/우리나라 113년 기후변화 분석 보고서_저용량.pdf`)
- **원문 (p.3)**: "1970년대 대비 2020년대 폭염일수: 수원(3.8일→18.3일),
  서울(5.5일→20.0일), 춘천(6.9일→20.5일), 대전(8.3일→27.8일), 광주(9.0일→
  22.5일), 완도(1.4일→14.8일), 합천(12.6일→30.5일), 부산(1.0일→8.8일) 등"
  / "1970년대 대비 2020년대 열대야일수: 인천(3.0일→26.3일), 서울(5.0일→
  29.5일), 춘천(1.6일→11.3일), 대전(3.3일→19.0일), 부안(2.6일→17.8일) 등"
- **판단**: 인용 숫자 자체는 정확했으나(2026-08-18 원문 대조), 파일명이
  "[기상청] 2025년 이상기후 보고서.pdf"(별개 발간물, 해당 연도 요약
  보고서)로 잘못 연결되어 있었음 — 실제 출처는 「우리나라 113년 기후변화
  분석 보고서」(별도 발간물, 2025-12-29 보도자료)로 정정. 두 PDF 모두
  `references/all_papers/`에 확보 완료.
- **확인**: 사용자 확인 완료 (2026-08-18) — PDF 원문 직접 대조

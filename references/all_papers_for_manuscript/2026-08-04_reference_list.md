...
- **확인**: 사용자 확인 완료 (2026-07-14)
- **1단락 재인용(2026-08-05 신규)**: "실외에서 신체 활동이 수반되는 보행의
  경우 폭염 시 열노출로 인한 위협이 더욱 커질 것이다(Basu et al., 2024;
  Jia et al., 2022)." — Basu 반복 인용 완화를 위해 추가. 원문(p.2):
  "Walking as a weather-exposed activity is highly influenced by climatic
  conditions [17–19]." (2026-08-05 4편 정독 시 확인됨, 위 인용과 별개
  페이지)
...
- **실제 용도(2026-08-05 갱신)**: 원래 IV장 §4.2 후보로 검토했으나,
  **실제로는 I장 서론 1단락에 반영됨** — "환경 조성 차이(Shin & Park,
  2026; McDonald et al., 2021)에 따라 공간적으로 불균등하게 분포하는
  경우가 많다." Shin & Park(2026)이 같은 문단에서 2번 인용되는 중복을
  완화하기 위해 "환경 조성 차이" 요인의 추가 근거로 배치. IV장§4.2
  용도는 보류(추후 검토).
